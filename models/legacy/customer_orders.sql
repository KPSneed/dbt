...
FROM dbt_datasets.raw_orders as Orders
...
left join dbt_datasets.raw_customers C on orders.USER_ID = C.ID ),
...
from dbt_datasets.raw_customers C 
left join dbt_datasets.raw_orders as Orders
